...
GEMINI_API_KEY = "AIzaSyCh1fZK3sVudp03gUZA4bv2gHDs07y7UoI"
...
if st.button("Detect News"):
    if title.strip() and text.strip():
        with st.spinner("Analyzing news with ML model and Gemini LLM..."):
            ...
            gemini_prompt = f"Is the following news real or fake? Please answer with REAL or FAKE and provide a short explanation:\n\n{content}"
